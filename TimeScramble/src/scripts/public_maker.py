...
if __name__ == "__main__":
    ...
    p.add_argument('-o', '--outDir', dest='outDir',
            ...
            default='/data/user/juancarlos/anisotropy/test/maps',
    ...
    if args.ebins and args.config[:2]=='IC':
        c_opts['spline'] = '{}/IC86_20904_hist_spline.fits'.format(prefix)
    ...
    validArgs  = ['config','nInt','method','outBase','spline','batchFile','sd']
