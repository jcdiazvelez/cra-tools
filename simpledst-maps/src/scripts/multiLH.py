...
if __name__ == "__main__":
	...
	#sourcefolder1 = './HAWC_mock_360steps/'
	#sourcefolder2 = './IceCube_mock_360steps/'
	#sourcefolder1 = '/data/user/juancarlos/anisotropy/HAWC/local/v7.1_local/'
	sourcefolder1 = '/data/user/juancarlos/anisotropy/HAWC/local/v7.1_local_sectors/sector%u/combined/' % sector
	#sourcefolder1 = '/data/user/juancarlos/anisotropy/HAWC/local/v7_local/'
	#sourcefolder2 = '/data/user/juancarlos/anisotropy/IceCube/localmaps/2015/n64/combined/'
	#sourcefolder2 = '/data/user/juancarlos/anisotropy/IceCube/localmaps/2015/cuts/n256/combined/'
	#sourcefolder2 = '/data/user/juancarlos/anisotropy/IceCube/localmaps/all-years/cuts/n256/combined/'
	#sourcefolder2 = '/data/user/juancarlos/anisotropy/IceCube/localmaps/all-years/newcuts/N64/combined/'
	sourcefolder2 = '/data/user/juancarlos/anisotropy/IceCube/localmaps/all-years/newcuts/N64/combined/sectors/sector%u/' % sector
	...
	Niteration = 20  #
	#Niteration = 10  #
	foldername = './HAWCv7.1_and_IceCube_v2_all_IC86.1_sector%u/' % sector
	...
	for timeidx in range(0,Ntimestep) :
		...
		# fake data:
		#namefile = sourcefolder1 + 'local_timeindex' + '{:03d}'.format(timeidx) + '.fits'
		#namefile = sourcefolder1 + 'hawclocal-v6_bin1_N64_'+'{:03d}'.format(timeidx)+'_of_360_.fits.gz'
		...
		#namefile = sourcefolder2 + 'local_timeindex' + '{:03d}'.format(timeidx) + '.fits'
