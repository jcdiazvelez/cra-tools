...
if __name__ == "__main__":
 ...
 for sector in range(7,13):
    #sector = "3"
    outdir = "/data/user/juancarlos/anisotropy/IceCube/localmaps/all-years/newcuts/N64/combined/months/%s/"%sector
    call(["mkdir", "-p", outdir])
    ...
    for bin in range(0,360):
        ...
        binfiles = glob.glob("/data/user/juancarlos/anisotropy/IceCube/localmaps/all-years/newcuts/N64/months/%s/*/CR_ICECUBE_LOCAL_0.00-4.50GeV_NSIDE64_degbin-%02d.fits.gz" % (sector,bin))
