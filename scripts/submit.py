...
if __name__ == "__main__":
    ...
    #outdir = "/data/user/juancarlos/anisotropy/isotropic/isomaps/"
    outdir = "/data/user/juancarlos/anisotropy/isotropic/isomaps.v8/"
    icecube_maps="/data/user/juancarlos/anisotropy/IceCube/localmaps/all-years/newcuts/N64/combined/"
    #hawc_maps="/data/user/juancarlos/anisotropy/HAWC/local/v7.1_local/"
    ...
    for bin in range(0,nmaps):
        ...
        exe = "/data/user/juancarlos/anisotropy/isotropic/isotropy.py"
