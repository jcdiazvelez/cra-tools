...
if __name__ == "__main__":
	...
	for i in range(0,npix) :
		...
		for timeidx in range(minstep,mppaxstep) :
	...
	if Nstart > 0 :
		...
		Emap = H.read_map(foldername + "exposure_32_360_iteration" + str(Nstart) + ".fits")
	else :
		...
		H.write_map(foldername + "exposure_32_360_iteration0.dat",Emap0)	
	...
	for iteration in range(Nstart,Niteration) :
		...
		nameEfits = foldername + 'exposure_32_360_iteration' + str(iteration+1) + '.fits'
